...
public class Tablerodos {
	...
	public void mostrarTablero(int largo, int ancho){
		...
		//	for (i=0;i<10;i++) {
			...
			int ubicX= 1;
			int ubicY= 1;
			objCarro[i]= new Trupalla (2, "Año "+String.valueOf(2014), ubicX, ubicY, 3, "Cop "+String.valueOf(2));
			...
			/*for (i=10;i<15;i++) {
				...
				cop++;
				if(tableroM[ubicX+1][ubicY+3]==0 && tableroM[ubicX+1][(ubicY+3)+1]==0) {
					tableroM[ubicX+1][ubicY+3]=3;
					indice++;
				}else {
					i--;
				}
			...
			for (i=15;i<18;i++) {
				...
				cop++;
				if(tableroM[ubicX+1][ubicY+3]==0) {
					tableroM[ubicX+1][ubicY+3]=4;
					indice++;
				}else {
					i--;
				}
